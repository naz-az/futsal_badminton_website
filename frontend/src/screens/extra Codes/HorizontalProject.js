...
function HorizontalProject({ project }) {
  ...
  return (
    <Card
      ...
      style={{ height: "380px", overflow: "hidden", padding: "5px 5px" }}
    >
      {" "}
      {/* Removed all padding from the Card */}
      {/* Modal component */}
      ...
      >
        {" "}
        {/* Removed all margin and padding */}
      ...
      <div
        style={{ width: "55%", marginRight: "30px" }}
        className="d-flex flex-column justify-content-between p-2 text-start mt-3 mb-3"
      >
        {" "}
      ...
      >
        {" "}
        {/* Apply horizontal padding only */}
        <div style={{ marginTop: "0px" }} className="mb-2 text-start">
          {" "}
          {/* Adding margin here */}
          {/* <Button
                        variant="warning"

...
function ProjectAttending({ project, onRemoveProject, onModalChange   }) {
...
<AttendButton projectId={project.id} token={localStorage.getItem("token")} onModalChange={onModalChange} onAttendChange={() => onRemoveProject(project.id)} style={{ marginRight: '1rem' }} />
...
export default ProjectAttending;
